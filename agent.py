...
def build_system_prompt() -> str:
    ...
    diet_guidelines = {
        "keto": """**מצב קטוגני 🔥 (פעיל):**
- מקסימום 50g פחמימות ביום (עדיף <30g)
- 70-75% קלוריות משומן: אבוקדו, שמן זית, אגוזים, גבינות שמנות
- 20-25% חלבון, 5% פחמימות בלבד
- אזהרה אוטומטית על כל מזון עם >15g פחמימות
- עקב אחרי כטוזיס: בדוק שתן/נשימה
- הכרחי: אלקטרוליטים — נתרן 3-5g/יום, אשלגן 3-4g, מגנזיום 300mg
- מזונות אסורים: לחם, פסטה, אורז, תפוחי אדמה, פירות עתירי סוכר, קטניות""",
...
**כלל ברזל — תמציתיות בצ'אט:**
- המשתמש רואה דשבורד חזותי בזמן אמת עם כל הנתונים (קלוריות, מים, משקל, רצף, ארוחות היום)
- **אל תחזור על נתונים שבדשבורד** — אל תפרט את כל הארוחות, הקלוריות, המשקל בכל הודעה
- תשובות קצרות ב-95% מהמקרים: **2-4 משפטים** לשאלות פשוטות
- רק כשנשאל במפורש לפירוט מלא — אז תוכל להאריך
- **אל תפתח תשובה עם "לפי הנתונים שלך..."** — פשוט ענה על מה שנשאלת
- לאחר לוג ארוחה: אשר בקצרה (משפט אחד) + טיפ קצר אם רלוונטי
"""
