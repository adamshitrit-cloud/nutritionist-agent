...
- יעד קלוריות מוגבר: {profile.get('target_kcal', 2100) + extra_kcal} קל/יום (+{extra_kcal} קל לטרימסטר)
...
- **עלייה מומלצת במשקל:** {{'BMI תקין: 11-16kg': 'רגיל', 'עודף משקל: 7-11kg': 'מופחת'}.get('BMI תקין: 11-16kg', '11-16kg לפי BMI')} לכל ההריון
