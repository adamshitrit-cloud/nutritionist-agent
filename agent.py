...
- מדד מפתח: גרמי חלבון ליום — אזהרה אם מתחת ל-150g""",
        ...
        "balanced": """**מצב מאוזן ⚖️ (פעיל):**
- אין הגבלות פחמימות — לחם, אורז, פסטה, קטניות מותרים לחלוטין
- יעד: 45-55% פחמימות, 25-35% שומן, 15-25% חלבון
- מגוון מכל קבוצות המזון — אין מזונות "אסורים"
- התמקד ביעד הקלורי היומי בלבד
- אין להחיל כללי קטוגני, ים-תיכוני, או צום על ההמלצות"""
    }.get(diet_mode, "")
